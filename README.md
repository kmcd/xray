...
| 2              | 0.3.0 – 0.4.13       | Author handles are opaque `h_<15 digits>` tokens ([ADR 023](docs/adr/0023-author-handles-hashed-at-boundary.md)). Analysers built for `schema_version = 1` must be updated. |
